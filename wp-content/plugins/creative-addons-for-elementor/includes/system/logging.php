...
class Logging {
	...
	const LOGGING_OPTION_NAME =  'crel_error_log';
	...
	public static function add_log( $error_message, $param1='', $param2=null ) {
		...
		$error_log[] = array( 'plugin' => CREATIVE_ADDONS_PLUGIN_NAME, 'date' => date("Y-m-d H:i:s"), 'message' => $error_message, 'trace' => $stack_trace );
	...
	private static function can_log_message() {
		...
		$is_debug_on = Utilities::get_wp_option( 'crel_debug_on', false );
