...
(function($, global) {
	...
	var CRELDialogsManager = {
		...
		createWidgetType: function(typeName, properties, Parent) {
			...
			WidgetType.extend = function(typeName, properties) {
				...
				return CRELDialogsManager.createWidgetType(typeName, properties, WidgetType);
			};
	 ...
	 */
	CRELDialogsManager.Instance = function() {
		...
		this.createWidget = function(widgetType, properties) {
			...
			var WidgetTypeConstructor = CRELDialogsManager.getWidgetType(widgetType),
	 ...
	 */
	CRELDialogsManager.Widget = function(widgetName) {
		...
		this.init = function(parent, properties) {
			...
			if (!(parent instanceof CRELDialogsManager.Instance)) {
				throw 'The ' + self.widgetName + ' must to be initialized from an instance of CRELDialogsManager.Instance';
			}
	...
	CRELDialogsManager.Widget.prototype.types = [];

	// Inheritable widget methods
	CRELDialogsManager.Widget.prototype.buildWidget = function() {
	...
	CRELDialogsManager.Widget.prototype.attachEvents = function() {
	...
	CRELDialogsManager.Widget.prototype.getDefaultSettings = function() {

		return {};
	};

	CRELDialogsManager.Widget.prototype.getClosureMethods = function() {

		return [];
	};

	CRELDialogsManager.Widget.prototype.onHide = function() {
	};

	CRELDialogsManager.Widget.prototype.onShow = function() {
	};

	CRELDialogsManager.Widget.prototype.onInit = function() {
	};

	CRELDialogsManager.Widget.prototype.onReady = function() {
	};

	CRELDialogsManager.widgetsTypes.simple = CRELDialogsManager.Widget;

	CRELDialogsManager.addWidgetType('buttons', {
		...
		buildWidget: function() {
			...
			CRELDialogsManager.Widget.prototype.buildWidget.apply(this, arguments);
	...
	CRELDialogsManager.addWidgetType('lightbox', CRELDialogsManager.getWidgetType('buttons').extend('lightbox', {
		getDefaultSettings: function() {

			var settings = CRELDialogsManager.getWidgetType('buttons').prototype.getDefaultSettings.apply(this, arguments);
		...
		buildWidget: function() {
			...
			CRELDialogsManager.getWidgetType('buttons').prototype.buildWidget.apply(this, arguments);
	...
	CRELDialogsManager.addWidgetType('confirm', CRELDialogsManager.getWidgetType('lightbox').extend('confirm', {
		onReady: function() {
		...
		getDefaultSettings: function() {
			...
			var settings = CRELDialogsManager.getWidgetType('lightbox').prototype.getDefaultSettings.apply(this, arguments);
	...
	CRELDialogsManager.addWidgetType('alert', CRELDialogsManager.getWidgetType('lightbox').extend('alert', {
		onReady: function() {
	...
	// Exporting the CRELDialogsManager variable to global
	global.CRELDialogsManager = CRELDialogsManager;
})(
