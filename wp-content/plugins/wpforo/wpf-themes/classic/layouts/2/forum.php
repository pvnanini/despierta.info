	  	...
	  	<div class="forum-wrap <?php wpforo_unread($forum['forumid'], 'forum') ?>">
	      	<div class="wpforo-forum">
				...
				<?php if($forum['last_postid'] != 0 ) : ?>
                    ...
                    <?php if( ( WPF()->perm->forum_can('enf', $last_post['forumid'])
                                || WPF()->perm->forum_can('vt', $last_post['forumid']) )
                                    && apply_filters('wpforo_display_last_topic', true, $last_post, $forum) ): ?>
                    ...
                    <?php else: ?>
                        <div class="wpforo-last-post">
                            <p class="wpforo-last-post-title"><br /><?php wpforo_phrase('No topic found'); ?></p>
                        </div>
