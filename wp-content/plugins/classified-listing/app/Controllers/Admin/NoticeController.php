...
class NoticeController
{
	...
	public function display_admin_notice() {
		...
		if (!in_array($pagenow, $exclude)) {
			$dont_disturb = add_query_arg('rtcl_skip', '1', $this->current_admin_url());
			$remind_me = add_query_arg('rtcl_reminder', '1', $this->current_admin_url());
			$rated = add_query_arg('rtcl_rated', '1', $this->current_admin_url());
	...
	public function black_friday_notice() {
		if (!rtcl()->has_pro() && get_option('rtcl_dismiss_admin_notice') != '1' && !isset($GLOBALS['rtcl_dismiss_admin_notice_notice'])) {
			...
			function () {
				...
				<div class="notice notice-info is-dismissible" data-rtcl-bf-dismiss-able="rtcl_dismiss_admin_notice"
					...
					<p style="margin:0 0 2px;">
						...
						<b><?php echo $plugin_name; ?> plan</b> with <b>UP TO 50% OFF</b>! Limited time offer expires on
						December 5.
					</p>
