...
class Functions {
	...
	public static function format_price_range( $from, $to ) {
		...
		$price = sprintf( _x( '<div class="rtcl-price-range">%1$s <span class="sep">&ndash;</span> %2$s</div>', 'Price range: from-to', 'classified-listing' ), is_numeric( $from ) ? self::price( $from ) : $from, is_numeric( $to ) ? self::price( $to ) : $to );
